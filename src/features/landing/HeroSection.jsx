...
export function HeroSection() {
  return (
    <section className="pt-32 pb-20 md:pt-40 md:pb-28 bg-brandYellow relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-brandDark text-brandYellow px-8 py-4 rounded-full font-bold text-lg hover:bg-black transition-all shadow-xl shadow-brandDark/20 flex items-center justify-center gap-2 group">
                Download App
          ...
          <div className="hidden lg:block relative">
            ...
            <img 
              ...
              className="w-full max-w-lg mx-auto h-auto object-contain relative z-10 drop-shadow-2xl hover:-translate-y-4 transition-transform duration-500"
            />
          </div>
